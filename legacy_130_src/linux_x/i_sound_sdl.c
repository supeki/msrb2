...
void I_UpdateSound () {
  /* Pour une raison que j'ignore, la version SDL n'appelle jamais
     ce truc directement. Fonction vide pour garder une compatibilit\E9
...
{ 
  ...
  /* Comprends pas pourquoi le SDL_Init avait \E9t\E9 comment\E9... */
