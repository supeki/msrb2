...
void R_SetupFrame (player_t* player)
{
    ...
    if ( rendermode == render_soft ) 
    {
        // clip it in the case we are looking a hardware 90\B0 full aiming
...
#ifdef FLOORSPLATS
	printf("R_ClearVisibleFloorSplats...\n");
...
#ifdef FLOORSPLATS
    //faB(21jan): testing
	printf("R_DrawVisibleFloorSplats...\n");
